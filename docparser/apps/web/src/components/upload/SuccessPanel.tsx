  ...
  return (
    <div className="flex flex-col items-center gap-6 py-14">
      <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-green-100 dark:bg-green-900/40">
        <div className="absolute inset-0 animate-ping rounded-full bg-green-200 opacity-50 dark:bg-green-800" />
        <div className="h-8 w-8 animate-spin rounded-full border-4 border-green-200 border-t-green-600 dark:border-green-800 dark:border-t-green-500" />
      </div>
      ...
      <div className="w-full max-w-2xl rounded-xl border border-neutral-200 dark:border-neutral-700">
        ...
        {showPayload ? (
          <div className="border-t border-neutral-100 px-4 pb-4 dark:border-neutral-700">
            <pre className="max-h-56 overflow-y-auto rounded-lg bg-neutral-900 p-4 text-xs text-green-300 dark:bg-neutral-950 font-mono scrollbar-thin">
              {payload}
            </pre>
          </div>
        ) : null}
