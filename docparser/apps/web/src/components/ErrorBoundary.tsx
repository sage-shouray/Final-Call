    ...
    if (this.state.error) {
      ...
      return (
        <div className="flex min-h-[400px] flex-col items-center justify-center gap-4 p-8 text-center">
          ...
          <div>
            <h2 className="text-base font-semibold text-neutral-800">Something went wrong</h2>
            <p className="mt-1 max-w-sm text-sm text-neutral-400">
              An unexpected error occurred. Refreshing the page usually fixes it.
            </p>
            {import.meta.env.DEV && (
              <pre className="mt-3 max-w-lg overflow-auto rounded-lg bg-neutral-100 p-3 text-left text-xs text-neutral-600">
